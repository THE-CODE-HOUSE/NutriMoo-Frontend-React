...
const showConfirmationDialog = () => {
    Alert.alert(
      ...
      [
        ...
        { text: "Remover", onPress: () => Toast.show('Animal removido com sucesso!'), 
...
const AnimalInfo = ({ navigation }) => {
    ...
    const openAdvancedInfo = () => {
        ...
        console.log("Tela de informações adicionais aberta!")
    }
            ...
            <View style={styles.retangulo}>
                  <View style={[ styles.retangulo,{ opacity: .9, backgroundColor: "#FBF6E9", height: "55%", }]}>
                    ...
                    <View style={{marginLeft: '65%',backgroundColor: '#FBF6E9', alignItems:'center', justifyContent: 'center', borderRadius:500, height:'12.5%', width: '13%',  marginTop: -20,resizeMode: "contain",elevation:5}}>
                          <TouchableOpacity style={{alignItems:'center'}} onPress={openEditAnimal} >
                    ...
                    <View style={{flexDirection: 'row', height: '100%'}}>
                          <TouchableOpacity style={{backgroundColor: '#BA1A1A', borderRadius: 25, width: '30%', height: '10%', alignItems: 'center',justifyContent:'center', elevation: 10}} onPress={showConfirmationDialog}>
                            <Text style={{color:'white', fontSize: 14, textAlign: 'center'}}>Remover animal</Text>
                          </TouchableOpacity>

                          <TouchableOpacity style={{backgroundColor: '#345A48', borderRadius: 25, marginLeft: '10%',width: '30%', height: '10%', alignItems: 'center',justifyContent:'center', elevation: 10}} onPress={openAdvancedInfo}>
                            <Text style={{color:'white', fontSize: 14, textAlign: 'center'}}>+ Infos</Text>
                          </TouchableOpacity>
                    </View>
